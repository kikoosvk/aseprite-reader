...
open class DataTest {
    ...
    */
    ...
    @Test
    fun getWord() {
        val data = Data(ubyteArrayOf(0x35U, 0x12U, 0xD4U, 0x59U, 0x89U, 0xFFU).toByteArray())
    ...
    fun getShort() {
        ...
        val data = Data(ubyteArrayOf(0xFFU, 0xFFU, 0xFFU, 0xFEU).toByteArray())
    ...
    @Test
    fun getDword() {
        val data = Data(ubyteArrayOf(0x78U, 0x56U, 0x34U, 0x12U).toByteArray())
    ...
    @Test
    fun getLong() {
        val data = Data(ubyteArrayOf(0x78U, 0x56U, 0x34U, 0xF2U).toByteArray())
